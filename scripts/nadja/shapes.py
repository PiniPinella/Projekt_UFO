...
# Diagramm speichern
plt.savefig(os.path.join(grafiken_ordner, "shapes_per_second"))
...
# Diagramm anzeigen
plt.savefig(os.path.join(grafiken_ordner, "shape_by_duration"))
...
plt.tight_layout()
plt.savefig(os.path.join(grafiken_ordner, "shapes_usa"))
...
plt.ylabel('UFO-Form', fontsize=12)
plt.tight_layout()
plt.savefig(os.path.join(grafiken_ordner, "shapes_germany"))
...
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join(grafiken_ordner, "shapes_jahre"))
